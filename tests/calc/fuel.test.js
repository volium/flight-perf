...
const slingProfile = {
  performance: {
    ...
    fuelConsumption: {
      ...
      data: [
        { rpm: 4500, fuelFlowLph: 14, fuelFlowGph: 3.7, airspeed: { value: 73, unit: 'kias' } },
        { rpm: 4800, fuelFlowLph: 16, fuelFlowGph: 4.2, airspeed: { value: 91, unit: 'kias' } },
        { rpm: 5000, fuelFlowLph: 18, fuelFlowGph: 4.8, airspeed: { value: 104, unit: 'kias' } },
        { rpm: 5300, fuelFlowLph: 20, fuelFlowGph: 5.3, airspeed: { value: 109, unit: 'kias' } },
        { rpm: 5500, fuelFlowLph: 21, fuelFlowGph: 5.6, airspeed: { value: 114, unit: 'kias' } },
      ],
    },
  },
  fuel: {
