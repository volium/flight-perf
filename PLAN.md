...
| 3A.9 | **Unit tests** for db.js, profile-validator, profile-merger, profile-migrator | 3A.1–3A.5 | 🔶 (db, validator, merger done) |
...
### Total: ~341 test cases across 16 test files
